<%-- 
    ...
    Created on : 25-may-2021, 1:20:05
    Author     : sagit
--%>
    ...
    <body>
        ...
        <div class="container">
            <div class="col-sm-6 mx-auto my-5">
                <p class="text-center tituloF">Registro de Articulo<p>            	
                <form action="ArticuloControl" method="post">
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label lab">Codigo</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="codArt" value="">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="sto" value="">
                        </div>
                    </div>
                    <div class="form-group row">
