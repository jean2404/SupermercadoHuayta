<%-- 
    Document   : EmpleadoEncontrado
    Created on : 06-may-2021, 17:22:18
    Author     : sagit
--%>
    ...
    <body>
        <div class="container">
            <div class="col-sm-6 mx-auto my-5">
                <p class="text-center tituloF">Editar Empleado<p>
                ...
                <form action="EmpleadoControl" method="post">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="cod" value="<%= f[0]%>">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="tip" value="<%= f[2]%>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label lab">Usuario</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="usu" value="<%= f[3]%>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label lab">Password</label>
                        <div class="col-sm-9">
                            <input type="password" class="form-control" name="pas" value="<%= f[4]%>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-4 mx-auto">

                            <a href="Menu.jsp" class="btn btn-light">Volver a Menu - Empleado</a>
                        </div>
                    </div>
